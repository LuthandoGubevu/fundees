...
export function StoryCard({ story }: { story: Story }) {
  ...
  return (
    <Card className="flex flex-col overflow-hidden rounded-xl shadow-md bg-sky-100/90 max-w-xs sm:max-w-sm w-full mx-auto transform hover:-translate-y-1 transition-transform duration-300">
